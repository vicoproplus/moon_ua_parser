...
> Published: `vicoproplus/moon_ua_parser_mars` 0.1.0 is live on the mooncakes registry (2026-09-13; publish evidence `docs/evidence/publish-final-2026-09-13.log` in the source repository) — `moon add` works as written.
